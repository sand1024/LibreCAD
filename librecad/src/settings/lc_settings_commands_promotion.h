...
#ifndef LC_SETTINGS_COMMANDS_PROMOTION_H
#define LC_SETTINGS_COMMANDS_PROMOTION_H

#include "lc_setting.h"

namespace CFG_CommandsPromotion {
    inline const LC_SettingsGroupBase Group("CommandsPromotion");
