...
void LC_ArcPropertiesEditingWidget::onRadiusTextChanged(const QString &text) const {
...
void LC_ArcPropertiesEditingWidget::onDiameterTextChanged(const QString &text) const {
    const double value = RS_Math::eval(text, 0.0);
    if (value > 0.0) {
...
void LC_ArcPropertiesEditingWidget::onArcLengthTextChanged(const QString &text) const {
    const double value = RS_Math::eval(text, 0.0);
    if (value > 0.0) {
        const double radius = m_entity->getRadius();
...
void LC_ArcPropertiesEditingWidget::onSweepAngleTextChanged(const QString &text) const {
...
void LC_ArcPropertiesEditingWidget::onBulgeTextChanged(const QString &text) const {
    const double value = RS_Math::eval(text, 0.0);
    if (value > 0.0) {
...
void LC_ArcPropertiesEditingWidget::onAngle1TextChanged(const QString &text) const {
...
void LC_ArcPropertiesEditingWidget::onAngle2TextChanged(const QString &text) const {
...
void LC_ArcPropertiesEditingWidget::updateDerivedFields(const double radius, const double theta) const {
...
void LC_ArcPropertiesEditingWidget::updateUI() const {
