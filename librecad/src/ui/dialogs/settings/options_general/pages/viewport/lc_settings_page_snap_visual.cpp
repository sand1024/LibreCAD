...
#include "lc_settings_page_snap_visual.h"
#include "ui_lc_settings_page_snap_visual.h"
#include "lc_settings_backend.h"
#include "lc_settings_colors.h"
#include "lc_settings_snap_visual.h"

LC_SettingsPageSnapVisual::LC_SettingsPageSnapVisual(QObject* parent)
    : LC_SettingsPageBase(tr("Visual Snap"), std::make_unique<LC_LibreCADSettingsBackend>(CFG_VisualSnap::Group), parent)
    , ui(std::make_unique<Ui::LC_SettingsPageSnapVisual>()) {
    setSortWeight(20);
}

LC_SettingsPageSnapVisual::~LC_SettingsPageSnapVisual() = default;

void LC_SettingsPageSnapVisual::setupUi() {
    ui->setupUi(m_widget);
}

void LC_SettingsPageSnapVisual::setupBehavior() {
...
void LC_SettingsPageSnapVisual::setupBindings() {
    ...
    bindInt({
        ...
        { ui->sbGuidingPointsLIneWidth, o_VSGuidingEntitiesLineWidth }
    });
