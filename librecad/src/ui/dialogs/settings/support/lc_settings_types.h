...
#ifndef LC_SETTINGS_TYPES_H
#define LC_SETTINGS_TYPES_H

#include <QString>
#include <QPointer>
#include <QWidget>

struct LC_SearchTarget {
    QString originalText;            // Cached localized plain text
    QPointer<QWidget> targetWidget;  // Widget to overlay highlight
};
