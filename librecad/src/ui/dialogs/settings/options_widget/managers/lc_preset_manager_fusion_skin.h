...
class LC_PresetManagerFusionSkin : public QObject, public LC_PresetManagerInterface, public LC_StylingPreviewAware {
    Q_OBJECT
public:
    ...
    // --- Skin Specific Accessors & Calculations ---
    SkinConfig& workingConfig() { return m_workingConfig; }
    const SkinConfig& workingConfig() const { return m_workingConfig; }
...
signals:
    void configLoaded(const SkinConfig& config);
