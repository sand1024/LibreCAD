...
#ifndef LC_SETTINGS_PAGE_METRICS_CONTROLS_H
#define LC_SETTINGS_PAGE_METRICS_CONTROLS_H
...
class LC_SettingsPageMetricsControls : public LC_SettingsPageBase {
    Q_OBJECT
public:
    explicit LC_SettingsPageMetricsControls(QObject* parent = nullptr);
    ~LC_SettingsPageMetricsControls() override;
