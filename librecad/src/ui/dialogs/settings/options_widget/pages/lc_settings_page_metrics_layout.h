...
#ifndef LC_SETTINGS_PAGE_METRICS_LAYOUT_H
#define LC_SETTINGS_PAGE_METRICS_LAYOUT_H

#include "lc_settings_page_base.h"

namespace Ui {
    class LC_SettingsPageMetricsLayout;
}

class LC_PresetManagerMetrics;

class LC_SettingsPageMetricsLayout : public LC_SettingsPageBase {
    Q_OBJECT
public:
    explicit LC_SettingsPageMetricsLayout(QObject* parent = nullptr);
...
private:
    ...
    std::unique_ptr<Ui::LC_SettingsPageMetricsLayout> ui;
