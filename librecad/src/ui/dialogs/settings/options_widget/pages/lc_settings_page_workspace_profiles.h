...
namespace Ui {
    class LC_SettingsPageWorkspaceProfiles;
}

class LC_UIStyleManager;

class LC_SettingsPageWorkspaceProfiles : public LC_SettingsPageBase {
    Q_OBJECT
public:
...
private:
    ...
    std::unique_ptr<Ui::LC_SettingsPageWorkspaceProfiles> ui;
};
