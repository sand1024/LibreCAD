...
void RS_ActionDrawLinePolygonCorCor::preparePolygonInfo(PolygonInfo& polygonInfo, const RS_Vector& snap) {
...
QString RS_ActionDrawLinePolygonCorCor::getPoint1Hint() const {
    return tr("Specify first corner");
}

QString RS_ActionDrawLinePolygonCorCor::getPoint2Hint() const {
